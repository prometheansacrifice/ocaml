...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'ocamlrun.wast';
  var wasmBinaryFile = 'ocamlrun.wasm';
  var asmjsCodeFile = 'ocamlrun.temp.asm.js';
...
var ASM_CONSTS = [function($0) {var process = require('child_process'); var result = process.spawnSync(Pointer_stringify($0), {shell: true}); return result.status;}];
...
STATICTOP = STATIC_BASE + 131808;
/* global initializers */  __ATINIT__.push({ func: function() { ___wasm_call_ctors() } });


var STATIC_BUMP = 131808;
...
// {{PRE_LIBRARY}}
  ...
  function ___invoke_double_i32(index, i) {
    try {
      return Module["dynCall_di"](index, i);
    } catch(e) {
  ...
  function ___invoke_i32_i32(index, i1) {
    // console.info('TESTING:', arguments);
    try {
      return Module["dynCall_ii"](index, i1);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
      Module["setThrew"](1, 0);
    }
  ...
  function ___invoke_i32_i32__i32(index, i1, i2) {
    try {
      return Module["dynCall_iii"](index, i1, i2);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
      Module["setThrew"](1, 0);
    }
  ...
  function ___invoke_i32_i32_i32(index, i1, i2) {
    try {
      return Module["dynCall_iii"](index, i1, i2);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
  ...
  function ___invoke_i32_i32_i32_i32(index, i1, i2, i3) {
    try {
      return Module["dynCall_iiii"](index, i1, i2, i3);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
      Module["setThrew"](1, 0);
    }
  ...
  function ___invoke_i32_i32_i32_i32_i32(index, i1, i2, i3, i4) {
    try {
      return Module["dynCall_iiiii"](index, i1, i2, i3, i4);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
      Module["setThrew"](1, 0);
    }
  ...
  function ___invoke_i32_i32_i32_i32_i32_i32(index, i1, i2, i3, i4, i5) {
    try {
      return Module["dynCall_iiiiii"](index, i1, i2, i3, i4, i5);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
      Module["setThrew"](1, 0);
    }
  ...
  function ___invoke_void_i32(index, i1) {
    try {
      Module["dynCall_vi"](index, i1);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
      Module["setThrew"](1, 0);
    }
  ...
  function ___invoke_void_i32__i32(index, i1, i2) {
    try {
      Module["dynCall_vii"](index, i1, i2);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
      Module["setThrew"](1, 0);
    }
  ...
  function ___invoke_void_i32_double(index, i1, d) {
    try {
      Module["dynCall_vid"](index, i1, d);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
      Module["setThrew"](1, 0);
    }
  ...
  function ___invoke_void_i32_i32__i32__i32(index, i1, i2, i3, i4) {
    try {
      Module["dynCall_viiii"](index, i1, i2, i3, i4);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
      Module["setThrew"](1, 0);
    }
  ...
  function ___invoke_void_i8__i8_(index, i1, i2) {
    try {
      Module["dynCall_vii"](index, i1, i2);
    } catch(e) {
      if (typeof e !== 'number' && e !== 'longjmp') throw e;
  ...
  var NODERAWFS={lookupPath:function (path) {
        ...
        // TEMPORARY: fs.unlinkSync.apply(void 0, arguments);
      },readlink:function () {
        ...
        // console.info("flags:", NODEFS.flagsForNode(flags));
        ...
        // fs.readSync(stream.nfs);
        return position;
      },read:function (stream, buffer, offset, length, position) {
        // console.info("READ:", stream.path);
        if (stream.stream_ops) {
          // this stream is created by in-memory filesystem
          return VFS.read(
            stream,
        ...
        try {
          ...
          console.info("WRONG READ: ", e);
        }
      },write:function (stream, buffer, offset, length, position) {
        // console.info("WRITE:", stream.path);
        if (stream.stream_ops) {
          // this stream is created by in-memory filesystem
          return VFS.write(
            stream,
        ...
        // console.info("WRITE IT DOWN:", position, stream.position);
        if (stream.flags & +"1024") {
          // seek to the end before writing in append mode
          // console.info("WRITE IT DOWN X2");
          FS.llseek(stream, 0, +"2");
        }
        // console.info("WRITE IT DOWN X:", stream.nfd);
        // console.info("Want to write to:", NODEFS.bufferFrom(buffer.buffer));
        ...
        try {
          ...
          if (stream.nfd > 2) {
            ...
            var str = String.fromCharCode.apply(
              null,
              new Uint8Array(buffer.buffer.slice(offset, offset + length))
            );

            // if (stream.path && stream.path.indexOf("parser.mli") > 0) {
            //   console.info(str, "> parser.mli");
            // }
          } else {
            var str = String.fromCharCode.apply(
              null,
            ...
            } else if (stream.nfd === 2) {
              process.stderr.write(str);
            } else {
              console.info("SOMETHING ELSE:", stream.nfd, str);
            }

            // console.info("wakawaka:", this.print, this.printErr);
  ...
  function _shmat() {
  Module['printErr']('missing function123: shmat'); abort(-1);
  }
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "___syscall221": ___syscall221, "___syscall220": ___syscall220, "_sin": _sin, "___syscall64": ___syscall64, "_pow": _pow, "_siglongjmp": _siglongjmp, "___syscall6": ___syscall6, "___invoke_void_i32__i32": ___invoke_void_i32__i32, "_sigaction": _sigaction, "___syscall5": ___syscall5, "_fork": _fork, "___invoke_double_i32": ___invoke_double_i32, "___syscall20": ___syscall20, "___syscall183": ___syscall183, "___invoke_i32_i32__i32": ___invoke_i32_i32__i32, "_floor": _floor, "_longjmp": _longjmp, "___invoke_void_i32_double": ___invoke_void_i32_double, "_sigaddset": _sigaddset, "_wait": _wait, "___setErrNo": ___setErrNo, "___syscall12": ___syscall12, "_sbrk": _sbrk, "___syscall192": ___syscall192, "_shmat": _shmat, "___syscall195": ___syscall195, "___invoke_void_i32": ___invoke_void_i32, "___invoke_i32_i32_i32_i32_i32_i32": ___invoke_i32_i32_i32_i32_i32_i32, "___invoke_void": ___invoke_void, "_sigemptyset": _sigemptyset, "__exit": __exit, "_testSetjmp": _testSetjmp, "_clock": _clock, "___syscall91": ___syscall91, "___buildEnvironment": ___buildEnvironment, "_cos": _cos, "___invoke_void_i32_i32__i32__i32": ___invoke_void_i32_i32__i32__i32, "_saveSetjmp": _saveSetjmp, "_kill": _kill, "___invoke_i32_i32_i32_i32": ___invoke_i32_i32_i32_i32, "_fabs": _fabs, "___invoke_void_i8__i8_": ___invoke_void_i8__i8_, "___syscall54": ___syscall54, "___unlock": ___unlock, "___syscall140": ___syscall140, "___syscall38": ___syscall38, "_emscripten_asm_const_iii": _emscripten_asm_const_iii, "___syscall10": ___syscall10, "_sigdelset": _sigdelset, "_log": _log, "___invoke_i32_i32_i32": ___invoke_i32_i32_i32, "_getenv": _getenv, "___invoke_i32_i32": ___invoke_i32_i32, "___lock": ___lock, "_abort": _abort, "_sigprocmask": _sigprocmask, "___syscall4": ___syscall4, "_time": _time, "___syscall3": ___syscall3, "_emscripten_longjmp": _emscripten_longjmp, "_sqrt": _sqrt, "_exit": _exit, "___invoke_i32_i32_i32_i32_i32": ___invoke_i32_i32_i32_i32_i32, "___syscall146": ___syscall146, "_waitpid": _waitpid, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "ABORT": ABORT };
...
var ___tempRet0 = Module["___tempRet0"] = function() { return Module["asm"]["__tempRet0"].apply(null, arguments) };
...
var ___threwValue = Module["___threwValue"] = function() { return Module["asm"]["__threwValue"].apply(null, arguments) };
...
var ___THREW__ = Module["___THREW__"] = function() { return Module["asm"]["__THREW__"].apply(null, arguments) };
